angular.module('theme.core.template_overrides', [])
  ...
  .run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put("template/modal/backdrop.html",
      ...
      "     ng-class=\"{in: uib-animate}\"\n" +
      "     ng-style=\"{'z-index': 1240 + (index && 1 || 0) + index*10}\"\n" +
      "></div>\n" +
      "");
    $templateCache.put("template/modal/window.html",
      "<div tabindex=\"-1\" role=\"dialog\" class=\"modal in fade\" ng-class=\"{in: animate}\" ng-style=\"{'z-index': 1250 + index*10, display: 'block'}\" ng-click=\"close($event)\">\n" +
      "    <div class=\"modal-dialog\" ng-class=\"{'modal-sm': size == 'sm', 'modal-lg': size == 'lg', 'modal-xlg': size == 'xlg'}\"><div class=\"modal-content\" uib-modal-transclude></div></div>\n" +
      "</div>");
    ...
    $templateCache.put("template/datepicker/day.html",
      ...
      "        <button type=\"button\" style=\"width:100%;\" class=\"btn btn-default btn-sm\" ng-class=\"{'btn-info': dt.selected, active: isActive(dt)}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\" tabindex=\"-1\"><span ng-class=\"{'text-muted': dt.secondary, 'text-black': dt.current}\">{{dt.label}}</span></button>\n" +
      "      </td>\n" +
      "    </tr>\n" +
      "  </tbody>\n" +
      "</table>\n" +
